...
public:
    ...
    * @return The point corresponding to \f$\mathbf{C}(0)\f$. */
    ...
    /** @brief Compute a time value at which the curve comes furtest to a specified point.
     * The first value with the smallest distance is returned if there are multiple such points.
     * @param p Query point
     * @param a Minimum time value to consider
     * @param b Maximum time value to consider; \f$a < b\f$
    ...
    /** @brief Compute time values at which the curve comes furtest to a specified point.
     * @param p Query point
     * @param a Minimum time value to consider
     * @param b Maximum time value to consider; \f$a < b\f$
     * @return Vector of points furthests and equally far away from the query point */
